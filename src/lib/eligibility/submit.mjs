// src/lib/eligibility/submit.mjs
/**
 * Pure, framework-agnostic submit adapter for the eligibility form.
 ...
 * The FormData must carry formType=eligibility so Code.gs routes it to the Eligibility sheet.
 *
 ...
 */
export async function submitEligibility(endpoint, formData, fetchImpl = globalThis.fetch) {
  try {
